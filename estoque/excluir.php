...
<section class=" mb-4 border rounded-3 p-4 border-primary-subtle">
     <h3 class="text-center"><i class="bi bi-trash3-fill"></i> Excluir Produto do Estoque</h3>
     ...
     <div class="alert alert-danger w-50 text-center mx-auto">
          <p>Deseja realmente exlucir o produto <b><?= $estoque['nome_produto'] ?? '' ?></b> da <b><?= $estoque['nome_loja'] ?? ''?></b>?</p>
          <a class="btn btn-secondary" href="listar.php"><i class="bi bi-x-circle"></i>  Não</a>
          <a class="btn btn-danger" href="?loja_id=?<?= $estoque['loja_id']?>&produto_id=<?= $estoque['produto_id']?>&confirmar-exclusao"><i class="bi bi-check-circle"></i> Sim</a>
     </div>
     <?php endif; ?>
